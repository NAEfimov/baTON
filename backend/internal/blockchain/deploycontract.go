...
func getWallet(api *ton.APIClient) *wallet.Wallet {
	words := strings.Split("pottery door office cat produce behave funny good obvious always provide ability wonder review awkward divert today hockey hen neutral position bright indoor disease", " ")
